...
" 分屏的代码 start
map br :set splitright<CR>:vsplit<CR>
map bl :set nosplitright<CR>:vsplit<CR>
map bb :set nosplitbelow<CR>:split<CR>
map bt :set splitbelow<CR>:split<CR>
" 分屏时，进行跳转分屏
nmap <leader>a <C-w>h
nmap <leader>d <C-w>l
nmap <leader>s <C-w>j
...
noremap <leader>l :LinesWithPreview<CR>
